...
export default function DashboardPage({
  ...
  // When any filter is active, filter raw_records then re-aggregate so all
  // tabs (which consume pre-computed fields) reflect the selection
  ...
  return (
    <div className="flex-1 flex overflow-hidden">
      ...
      <div className="flex-1 p-6 overflow-auto">
        {isLoading ? (
          <div className="flex items-center justify-center h-64 text-dark-dim animate-pulse">
            Loading…
          </div>
        ) : error ? (
          ...
          <>
            <div className="mb-4">
              ...
              <div className="text-xs text-dark-dim mt-0.5 flex items-center gap-2 flex-wrap">
                <span>
                ...
                {isFiltered && (
                  <button
                    ...
                    className="text-[10px] text-dark-dim hover:text-red-400 underline"
                  >
                    Clear filters
                  </button>
                )}
            ...
            {!filteredData ? (
              <div className="flex flex-col items-center justify-center py-20 text-dark-dim">
